...
class BiRebotB601Follower(BimanualMixin, Robot):
    ...
    def __init__(self, config: BiRebotB601FollowerConfig):
        ...
        left_arm_config = RebotB601FollowerRobotConfig(
            ...
            max_target_velocity_deg_s=config.left_arm_config.max_target_velocity_deg_s,
            max_target_step_deg=config.left_arm_config.max_target_step_deg,
        ...
        right_arm_config = RebotB601FollowerRobotConfig(
            ...
            max_target_velocity_deg_s=config.right_arm_config.max_target_velocity_deg_s,
            max_target_step_deg=config.right_arm_config.max_target_step_deg,
